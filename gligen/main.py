...
if __name__ == "__main__":
    ...
    parser.add_argument("--DATA_ROOT", type=str,  default="/home/v-yuhengli/data", help="path to DATA")
    parser.add_argument("--OUTPUT_ROOT", type=str,  default="../", help="path to OUTPUT")
